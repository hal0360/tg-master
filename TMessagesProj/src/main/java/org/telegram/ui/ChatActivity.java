    ...
    public class ChatActivityAdapter extends RecyclerView.Adapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
           ...
           // view.setLayoutParams(new RecyclerView.LayoutParams(RecyclerView.LayoutParams.MATCH_PARENT, RecyclerView.LayoutParams.WRAP_CONTENT));
            ...
            if(poop == 44) {
                view = LayoutInflater.from(parent.getContext()).inflate(R.layout.video_box, parent, false);
            }
            //nigger
           // view = LayoutInflater.from(parent.getContext()).inflate(R.layout.video_box, parent, false);
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
         ...
         //   IjkVideoView videoView = holder.itemView.findViewById(R.id.my_player);
          //  videoView.setVideoPath("rtmp://wmvdo.nicejj.cn/live1/720p");
          //  videoView.start();
                ...
                if (view instanceof ChatMessageCell) {
                    ...
                    if (createUnreadMessageAfterId != 0) {
                       ...
                       IjkVideoView videoView = holder.itemView.findViewById(R.id.my_player);
                        ...
                        videoView.setVideoPath(messages.get(position - messagesStartRow).messageText.toString().trim());
                        videoView.start();
        ...
        public int getItemViewType(int position) {
            if (position >= messagesStartRow && position < messagesEndRow) {
                ...
                int pootype = messages.get(position - messagesStartRow).contentType;
                if(pootype == 0){

                    try {
                        String mssd = messages.get(position - messagesStartRow).messageText.toString().trim();
                        if(mssd.length() >  5){
                            if(mssd.substring(0, 5).equals("rtmp:")){
